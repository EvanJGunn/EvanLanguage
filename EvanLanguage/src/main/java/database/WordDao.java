...
public interface WordDao {
    ...
    /**
     * Get a random list of words from a specified language, the number of words
     * returned will be exactly the specified amount, or zero if no words for the
     * language exist in the database.
     * 
